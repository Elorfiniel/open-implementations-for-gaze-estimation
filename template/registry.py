...
HOOKS = Registry('hook', parent=MMENGINE_HOOKS, locations=['template.engine.hooks'])

# manage data-related modules
DATASETS = Registry('dataset', parent=MMENGINE_DATASETS, locations=['template.datasets'])
DATA_SAMPLERS = Registry('data sampler', parent=MMENGINE_DATA_SAMPLERS)
TRANSFORMS = Registry('transform', parent=MMENGINE_TRANSFORMS, locations=['template.transforms'])
...
METRICS = Registry('metric', parent=MMENGINE_METRICS, locations=['template.evaluation'])
# manage evaluator
EVALUATOR = Registry('evaluator', parent=MMENGINE_EVALUATOR, locations=['template.evaluation'])
